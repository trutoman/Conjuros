...
export function CollectionList({ items, onReorder, onEdit, onDelete }: { items: CollectionItem[]; onReorder: (id: string, order: number) => void; onEdit: (item: CollectionItem) => void; onDelete: (item: CollectionItem) => void }) {
